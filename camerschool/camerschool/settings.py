"""
Django settings for camerschool project.
...
SECRET_KEY = 'django-insecure-$o0h_h)^3ofi@+ezhkg6c17lv4n8$vc#*u07*+_(k)x2!v%z4f'
...
WSGI_APPLICATION = 'camerschool.wsgi.application'
